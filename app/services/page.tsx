      ...
      <section className="py-24" style={{ background: "var(--warm-white)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-charcoal-500 text-sm mt-4 max-w-2xl mx-auto leading-relaxed">
                ...
                we work with a wide range of metals, plating options, and stones — all sourced from verified
                suppliers with material certifications available on request.
              </p>
            </div>
          </RevealOnScroll>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <RevealOnScroll>
              <div>
                <h3 className="font-display text-2xl text-charcoal-900 mb-6 pb-3 border-b border-charcoal-100" style={{ fontFamily: "var(--font-cormorant)" }}>
                  Base Metals
                </h3>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-charcoal-400 text-sm mt-4 max-w-2xl mx-auto leading-relaxed">
                ...
                We source from verified suppliers and support prong, bezel, pavé, channel, and micro-setting.
              </p>
            </div>
          </RevealOnScroll>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "◈", title: "Natural Diamond", desc: "Round brilliant, fancy shapes, and melee diamonds. GIA-certified stones available on request. Ideal for fine jewelry and high-end private label brands." },
              { icon: "◇", title: "Lab Grown Diamond", desc: "Physically and chemically identical to natural diamonds. Conflict-free and cost-effective. Growing demand from USA, Canada, and Australian brands." },
              { icon: "◉", title: "Moissanite", desc: "Superior brilliance and fire. Near-diamond hardness (9.25 Mohs). Popular alternative for brands targeting the premium segment at accessible price points." },
              { icon: "◎", title: "CZ (Cubic Zirconia)", desc: "High-quality AAA+ grade CZ in all shapes and sizes. Cost-effective for fashion and bridge jewelry. Available in white and colored stones." },
            ].map((s, i) => (
              <RevealOnScroll key={s.title} delay={i * 80}>
                <div className="border border-charcoal-800 p-8 hover:border-gold-500 transition-all duration-400 group">
                  ...
                  <h3 className="text-white font-display text-xl mb-3 group-hover:text-gold-200 transition-colors duration-300" style={{ fontFamily: "var(--font-cormorant)" }}>{s.title}</h3>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <RevealOnScroll delay={200}>
            <p className="text-center text-charcoal-500 text-sm mt-8 leading-relaxed">
              ...
              <Link href="/contact" className="hover:text-gold-500 transition-colors duration-300" style={{ color: "var(--gold)" }}>
